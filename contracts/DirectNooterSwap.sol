...
contract DirectNooterSwap is Ownable {
    ...
    /**
     * @dev Add all the farm tokens in a single function
     */
    function addAllFarmTokens() external onlyOwner {
        // Add ABSTER (0xC3f63f74501D225E0CAA6EceA2c8ee73092B3062)
        if (!supportedTokens[0xC3f63f74501D225E0CAA6EceA2c8ee73092B3062].isSupported) {
            supportedTokens[0xC3f63f74501D225E0CAA6EceA2c8ee73092B3062] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0xC3f63f74501D225E0CAA6EceA2c8ee73092B3062);
            emit TokenAdded(0xC3f63f74501D225E0CAA6EceA2c8ee73092B3062);
        }
        
        // Add ABBY (0x529aF9EbFD8612077bA6b0B72F2898EF7be337D1)
        if (!supportedTokens[0x529aF9EbFD8612077bA6b0B72F2898EF7be337D1].isSupported) {
            supportedTokens[0x529aF9EbFD8612077bA6b0B72F2898EF7be337D1] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x529aF9EbFD8612077bA6b0B72F2898EF7be337D1);
            emit TokenAdded(0x529aF9EbFD8612077bA6b0B72F2898EF7be337D1);
        }
        
        // Add CHESTER (0x2460a0068A154C7F2673417dA09f6AE81Ce70e56)
        if (!supportedTokens[0x2460a0068A154C7F2673417dA09f6AE81Ce70e56].isSupported) {
            supportedTokens[0x2460a0068A154C7F2673417dA09f6AE81Ce70e56] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x2460a0068A154C7F2673417dA09f6AE81Ce70e56);
            emit TokenAdded(0x2460a0068A154C7F2673417dA09f6AE81Ce70e56);
        }
        
        // Add DOJO3 (0x46BE8d4a214D6ddecE0b3251d76d42E186927781)
        if (!supportedTokens[0x46BE8d4a214D6ddecE0b3251d76d42E186927781].isSupported) {
            supportedTokens[0x46BE8d4a214D6ddecE0b3251d76d42E186927781] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x46BE8d4a214D6ddecE0b3251d76d42E186927781);
            emit TokenAdded(0x46BE8d4a214D6ddecE0b3251d76d42E186927781);
        }
        
        // Add FEATHERS (0xb4e815813875366e2b4e65eA857278Ae5bEceDc3)
        if (!supportedTokens[0xb4e815813875366e2b4e65eA857278Ae5bEceDc3].isSupported) {
            supportedTokens[0xb4e815813875366e2b4e65eA857278Ae5bEceDc3] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0xb4e815813875366e2b4e65eA857278Ae5bEceDc3);
            emit TokenAdded(0xb4e815813875366e2b4e65eA857278Ae5bEceDc3);
        }
        
        // Add MOP (0x45955765a7898f707a523CB1B7a6e3A95DDD5CD7)
        if (!supportedTokens[0x45955765a7898f707a523CB1B7a6e3A95DDD5CD7].isSupported) {
            supportedTokens[0x45955765a7898f707a523CB1B7a6e3A95DDD5CD7] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x45955765a7898f707a523CB1B7a6e3A95DDD5CD7);
            emit TokenAdded(0x45955765a7898f707a523CB1B7a6e3A95DDD5CD7);
        }
        
        // Add NUTZ (0x77D29085727405340946919A88B0Ac6c9Ffb80BD)
        if (!supportedTokens[0x77D29085727405340946919A88B0Ac6c9Ffb80BD].isSupported) {
            supportedTokens[0x77D29085727405340946919A88B0Ac6c9Ffb80BD] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x77D29085727405340946919A88B0Ac6c9Ffb80BD);
            emit TokenAdded(0x77D29085727405340946919A88B0Ac6c9Ffb80BD);
        }
        
        // Add PAINGU (0x8033d82e1e0f949C0986F9102a01C405831b784A)
        if (!supportedTokens[0x8033d82e1e0f949C0986F9102a01C405831b784A].isSupported) {
            supportedTokens[0x8033d82e1e0f949C0986F9102a01C405831b784A] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x8033d82e1e0f949C0986F9102a01C405831b784A);
            emit TokenAdded(0x8033d82e1e0f949C0986F9102a01C405831b784A);
        }
        
        // Add PENGUIN (0x8814046950cDA7aee1B249C1689d070C0db6E58D)
        if (!supportedTokens[0x8814046950cDA7aee1B249C1689d070C0db6E58D].isSupported) {
            supportedTokens[0x8814046950cDA7aee1B249C1689d070C0db6E58D] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x8814046950cDA7aee1B249C1689d070C0db6E58D);
            emit TokenAdded(0x8814046950cDA7aee1B249C1689d070C0db6E58D);
        }
        
        // Add PUDGY (0xEcbC4AB2ed8fce5C04dfB1104947Ca4891597336)
        if (!supportedTokens[0xEcbC4AB2ed8fce5C04dfB1104947Ca4891597336].isSupported) {
            supportedTokens[0xEcbC4AB2ed8fce5C04dfB1104947Ca4891597336] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0xEcbC4AB2ed8fce5C04dfB1104947Ca4891597336);
            emit TokenAdded(0xEcbC4AB2ed8fce5C04dfB1104947Ca4891597336);
        }
        
        // Add RETSBA (0x26707CE367C4758F73EF09fA9D8d730869a38e10)
        if (!supportedTokens[0x26707CE367C4758F73EF09fA9D8d730869a38e10].isSupported) {
            supportedTokens[0x26707CE367C4758F73EF09fA9D8d730869a38e10] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x26707CE367C4758F73EF09fA9D8d730869a38e10);
            emit TokenAdded(0x26707CE367C4758F73EF09fA9D8d730869a38e10);
        }
        
        // Add WOJACT (0x13D6CbB5f602Df7784bbb9612c5314CDC1ba9d3c)
        if (!supportedTokens[0x13D6CbB5f602Df7784bbb9612c5314CDC1ba9d3c].isSupported) {
            supportedTokens[0x13D6CbB5f602Df7784bbb9612c5314CDC1ba9d3c] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0x13D6CbB5f602Df7784bbb9612c5314CDC1ba9d3c);
            emit TokenAdded(0x13D6CbB5f602Df7784bbb9612c5314CDC1ba9d3c);
        }
        
        // Add YUP (0xF5048aD4FB452f4E39472d085E29994f6088d96B)
        if (!supportedTokens[0xF5048aD4FB452f4E39472d085E29994f6088d96B].isSupported) {
            supportedTokens[0xF5048aD4FB452f4E39472d085E29994f6088d96B] = TokenInfo({
                isSupported: true,
                balance: 0
            });
            tokenList.push(0xF5048aD4FB452f4E39472d085E29994f6088d96B);
            emit TokenAdded(0xF5048aD4FB452f4E39472d085E29994f6088d96B);
        }
    }
